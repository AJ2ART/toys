...
class ToysControllerTest < ActionController::TestCase
  ...
  test "should create toy" do
    assert_difference('Toy.count') do
      post :create, toy: { descrition: @toy.descrition, manufactuer: @toy.manufactuer, name: @toy.name, price: @toy.price }
    end
  ...
  test "should update toy" do
    patch :update, id: @toy, toy: { descrition: @toy.descrition, manufactuer: @toy.manufactuer, name: @toy.name, price: @toy.price }
    assert_redirected_to toy_path(assigns(:toy))
  end
